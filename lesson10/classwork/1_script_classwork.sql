...
CREATE TABLE group_teacher(
	...
	CONSTRAINT FK_group_teacher FOREIGN KEY(group_id) REFERENCES  groups(id),
	CONSTRAINT FK_teacher_groupr FOREIGN KEY(teacher_id) REFERENCES  teachers(id),
...
CREATE TABLE group_teacher_status(
	id int PRIMARY KEY IDENTITY(1,1) NOT NULL,
	title varchar(32) NOT NULL,
...
CREATE TABLE group_teacher(
	...
	CONSTRAINT FK_group_teacher_status FOREIGN KEY(status_id) REFERENCES group_teacher_status(id)
